    ...
    public static class RawKeyRecordWriter<K, V> extends RecordWriter<K, V> {
        ...
        private void writeObject(Object o) throws Exception {
            if (o instanceof SqoopRecord) {
                try {
                    ...
                    long generateRowsStart = System.currentTimeMillis();
                    ...
                    System.out.println("[ARGODB-SQOOP][ERROR] Encounter exception when writeObject: "
                ...
                System.out.println("[ARGODB-SQOOP][ERROR] o is not SqoopRecord");
        ...
        public synchronized void close(TaskAttemptContext context) throws IOException {
            try {
                ...
                System.out.println("[ARGODB-SQOOP] Flush begin at [" + flushStart + "]");
                LOG.info("[ARGODB-SQOOP] Flush begin at [" + flushStart + "]");

                sinkClient.flush();

                long end = System.currentTimeMillis();
                System.out.println("[ARGODB-SQOOP] Flush end at [" + flushStart + "]");
                LOG.info("[ARGODB-SQOOP] Flush end at [" + flushStart + "]");

                System.out.println("[ARGODB-SQOOP] ArgoDBSink flush spend [" + (end - flushStart) + "] ms.");
